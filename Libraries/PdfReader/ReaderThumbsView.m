...
- (void)requeueAllThumbCells
{
    ...
    //화면에 보여지는 갯 수
    NSLog(@"Screencount : %d",thumbCellsVisible.count);
...
- (void)reloadThumbsContentOffset:(CGPoint)newContentOffset
{
   ...
   // NSLog(@"thumbCnt : %d",thumbCount);
    ...
    //책깔피 버튼 처리.
    thumbCtrl = (ThumbsViewController *)[self.superview nextResponder];
    [thumbCtrl setHiddenToolbarBtn];
