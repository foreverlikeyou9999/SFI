...
@implementation OutlineMainToolbar
...
- (id)initWithFrame:(CGRect)frame title:(NSString *)title
{
	...
	if ((self = [super initWithFrame:frame]))
	{
		...
		[doneButton setBackgroundImage:[UIImage imageNamed:@"bt_02.png"] forState:UIControlStateNormal];
        [doneButton setBackgroundImage:[UIImage imageNamed:@"bt_02_on.png"] forState:UIControlStateHighlighted];
...
#if (OUTLINE_BOOKMARKS == TRUE) // Option
...
- (void)showControlTapped:(NSInteger)control
{
#ifdef DEBUGX
	NSLog(@"%s", __FUNCTION__);
#endif
